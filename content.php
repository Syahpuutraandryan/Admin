...
// === Tambahan modul Tugas (selaras dengan gaya router sebelumnya) ===

// GURU
if($_GET['module']=="daftar_tugas"){
include "module/tugas/daftar_tugas.php";
}
if($_GET['module']=="input_tugas"){
include "module/tugas/input_tugas.php";
}
if($_GET['module']=="input_nilai"){
include "module/tugas/input_nilai.php";
}

// USER
if($_GET['module']=="pengumpulan"){
include "module/tugas/pengumpulan.php";
}
if($_GET['module']=="view_nilai"){
include "module/tugas/view_nilai.php";
}
?>